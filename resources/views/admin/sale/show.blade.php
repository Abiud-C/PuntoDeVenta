                            ...
                            <table id="saleDetails" class="table">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <p align="right">MXN/{{number_format($subtotal*$sale->tax/100,2)}}</p>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="4">
                                        ...
                                        <th>
                                            <p align="right">MXN/{{number_format($sale->total,2)}}</p>
                                        </th>
                                    </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>MXN/ {{$saleDetail->price}}</td>
                                        <td>{{$saleDetail->discount}} %</td>
                                        <td>{{$saleDetail->quantity}}</td>
                                        <td>MXN/{{number_format($saleDetail->quantity*$saleDetail->price - $saleDetail->quantity*$saleDetail->price*$saleDetail->discount/100,2)}}
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
