...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dni'=>'string|required|unique:clients,dni,'.$this->route('client')->id.'|min:10|max:10',
            'ruc'=>'string|required|unique:clients,ruc,'.$this->route('client')->id.'|min:13|max:13',
            'address'=>'string|required|max:255',
            'phone'=>'string|required|unique:clients,phone,'.$this->route('client')->id.'|min:10|max:10',
